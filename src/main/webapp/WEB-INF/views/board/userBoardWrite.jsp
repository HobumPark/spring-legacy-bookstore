...
<link href="${pageContext.request.contextPath}/resources/css/board/userBoardWrite.css" type="text/css" rel="stylesheet">
		...
		<header id="header">
			<div id="header-top">
				...
				%>
					...
					<a href="#">주문배송</a> <a href="${pageContext.request.contextPath}/basket">장바구니</a>
				</div>
			</div>
			...
			<div id="contents-inner">
				...
				<div id="contents-right">
					...
					<div id="user-main">
						...
						<div id="user-board">
							<form id="board-write-form" method="post"  enctype="multipart/form-data" 
							action="${pageContext.request.contextPath}/board/user/write">
								<div id="board-write">
									...
									<div id="btn-area">
										<div id="btn-area-inner">
											<input type='submit' id="write-btn" value="등록"/>
											<input type='button' id="cancle-btn" value="취소"/>
										</div>
									</div>
								</div>
							</form>
