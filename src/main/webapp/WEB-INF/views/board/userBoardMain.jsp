...
<link href="${pageContext.request.contextPath}/resources/css/board/userBoardMain.css" type="text/css" rel="stylesheet">
					...
					<div id="user-main">
						...
						<div id="user-board">
							<div id="user-board-list">
								...
								<c:forEach items="${userBoardList}" var="user">
									<div id="user">
										<span>${user.no}</span>
										<span>
											<a href="${pageContext.request.contextPath}/board/user/view?no=${user.no}">
												${user.title}
												<c:if test="${user.commentCount ne 0}">
													<b>
														(${user.commentCount})
													</b>
												</c:if>
								...
								<c:forEach items="${pageArr}" var="page">
										...
										<c:if test="${curPage eq page}">
									    	<span id="page" class="active">
												<a href="${pageContext.request.contextPath}/board/user?page=${page}">
													${page}
												</a>
											</span>
										</c:if>
							...
							<div id="board-write">
								<%
									...
									{
								%>
								<a href="${pageContext.request.contextPath}/board/user/write">
									등록
								</a>
								<%
									}
