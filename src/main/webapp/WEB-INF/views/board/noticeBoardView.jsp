...
<link href="${pageContext.request.contextPath}/resources/css/board/noticeBoardView.css" type="text/css" rel="stylesheet">
			...
			<div id="contents-inner">
				...
				<div id="contents-right">
					...
					<div id="notice-main">
						...
						<div id="notice-board">
							<div id="notice-title">
								<div id="notice-title-top">
									${noticeView.title}
								</div>
								<div id="notice-title-bottom">
									<span>${noticeView.type}</span>
									<span>${noticeView.writeDate}</span>
								</div>
							</div>
